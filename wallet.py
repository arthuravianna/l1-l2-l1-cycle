class Wallet:
    ...
    def deposit(self, deposit_data):
        deposit_data["token_addr"] = deposit_data["token_addr"].lower()
        ...
        if "token_id" not in deposit_data:
            ...
            deposit_data["token_id"] = int(deposit_data["token_id"])
            
            self.erc721[deposit_data["token_addr"]].add(deposit_data["token_id"])


    def withdraw(self, withdraw_data):
        withdraw_data["token_addr"] = withdraw_data["token_addr"].lower()
        ...
        if "token_id" not in withdraw_data:
            ...
            withdraw_data["token_id"] = int(withdraw_data["token_id"])
